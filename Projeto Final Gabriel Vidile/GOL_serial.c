...
#include <stdlib.h>
#include <time.h> // Incluir a biblioteca time.h para medir o tempo
...
int main(int argc, char *argv[])
{
  ...
  clock_t start = clock(); // Iniciar a medição do tempo
  ...
  clock_t end = clock();                                      // Fim da medição do tempo
  double time_spent = (double)(end - start) / CLOCKS_PER_SEC; // Calcular o tempo gasto
